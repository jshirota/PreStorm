...
namespace PreStorm
{
    ...
    public interface IService
    {
        ...
        /// <returns></returns>
        Task<T[]> DownloadAsync<T>(int layerId, string whereClause = null, string extraParameters = null) where T : Feature;
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<T[]> DownloadAsync<T>(int layerId, string whereClause, GeometryBase geometry, SpatialRel spatialRel, string extraParameters = null) where T : Feature;
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<T[]> DownloadAsync<T>(string layerName, string whereClause = null, string extraParameters = null) where T : Feature;
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<T[]> DownloadAsync<T>(string layerName, string whereClause, GeometryBase geometry, SpatialRel spatialRel, string extraParameters = null) where T : Feature;
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<DynamicFeature[]> DownloadAsync(int layerId, string whereClause = null, string extraParameters = null);
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<DynamicFeature[]> DownloadAsync(int layerId, string whereClause, GeometryBase geometry, SpatialRel spatialRel, string extraParameters = null);
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<DynamicFeature[]> DownloadAsync(string layerName, string whereClause = null, string extraParameters = null);
        ...
        /// <param name="extraParameters">The query string that describes any additional query parameters (i.e. outSR=4326).  Each parameter must be url encoded.</param>
        /// <returns></returns>
        Task<DynamicFeature[]> DownloadAsync(string layerName, string whereClause, GeometryBase geometry, SpatialRel spatialRel, string extraParameters = null);
